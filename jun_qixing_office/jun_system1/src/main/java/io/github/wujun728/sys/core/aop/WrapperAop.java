...
import io.github.wujun728.core.annotion.Wrapper;
import io.github.wujun728.core.consts.AopSortConstant;
import io.github.wujun728.core.exception.ServiceException;
import io.github.wujun728.core.exception.enums.WrapperExceptionEnum;
import io.github.wujun728.core.pojo.base.wrapper.BaseWrapper;
...
public class WrapperAop {
     ...
     * @date 2020/7/24 17:42
     */
    @Pointcut("@annotation(io.github.wujun728.core.annotion.Wrapper)")
    ...
    private Object processWrapping(ProceedingJoinPoint proceedingJoinPoint, Object originResult) throws IllegalAccessException, InstantiationException {
        ...
        // 如果是PageResult类型
            ...
            ArrayList<Map<String, Object>> maps = new ArrayList<>();
            for (Object wrappedItem : pageResult.getData()) {
                maps.add(this.wrapPureObject(wrappedItem, baseWrapperClasses));
            }
