...
package io.github.wujun728.sys.modular.role.service.impl;
...
import io.github.wujun728.sys.modular.role.enums.SysRoleExceptionEnum;
import io.github.wujun728.sys.modular.role.mapper.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public void add(SysRoleParam sysRoleParam) {
        ...
        if(ObjectUtil.isEmpty(sysRole.getDataScopeType())) {
            sysRole.setDataScopeType(SysRoleDataScopeTypeEnum.ALL.getCode());
        }
        this.save(sysRole);
    }
