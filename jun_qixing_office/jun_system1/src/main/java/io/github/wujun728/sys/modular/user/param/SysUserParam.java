...
package io.github.wujun728.sys.modular.user.param;

import lombok.Data;
import lombok.EqualsAndHashCode;
import io.github.wujun728.core.pojo.base.param.BaseParam;
import io.github.wujun728.core.validation.date.DateValue;
...
public class SysUserParam extends BaseParam {
     ...
     * 密码
     */
    @NotBlank(message = "密码不能为空，请检查password参数", groups = {add.class, updatePwd.class})
