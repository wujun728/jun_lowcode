...
//                permission.getId(),
        ...
        if("dic".equals("dic"/*permission.getPermissionType()*/) && "selfOrAll".equals("selfOrAll"/*permission.getPermissionValue()*/)){
            //查看自己/全部
            if(configValues.contains("all")){
                return "";
            }
            return " and "+field+"="+session.getUserId()+" ";
        }else if("dic".equals("dic"/*permission.getPermissionType()*/) && "dept".equals("dept"/*permission.getPermissionValue()*/)){
            //部门数据权限
            if(configValues.contains("all")){
                return "";
            }
