...
//    private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
    ...
    public <T> Result<PageData<T>> query(PageParam pageParam, Class<T> clz, String sql, Object... args) {
        ...
        Integer count = getJdbcTemplate().queryForObject(countSql, Integer.class, args);
        ...
        List<T> data = getJdbcTemplate().query(pageSql, RowMapperUtil.newRowMapper(clz),args);
    ...
    public Result<PageData<Map<String,Object>>> query(PageParam pageParam,String sql,Object... args) {
        ...
        List<Map<String,Object>> data = getJdbcTemplate().query(pageSql, RowMapperUtil.newMapMapper(),args);
    ...
    public <T> List<T> find(String sql, Class<T> clz, Object... args) {
        ...
        return getJdbcTemplate().query(sql,RowMapperUtil.newRowMapper(clz),args);
    }
    ...
    public List<Map<String, Object>> find(String sql, Object... args) {
        log.info(StrUtil.format("查询 {},{}"),sql,args);
        return getJdbcTemplate().query(sql,RowMapperUtil.newMapMapper(),args);
    }
    @Override
    ...
    private String getTableName(Class clz){
        return StringUtil.toTableName(clz.getSimpleName());
    }
    @Override
    public List<ColumnMeta> columnMeta(String sql) {
        return columnMeta(sql,getJdbcTemplate());
    }

    @Override
    public List<ColumnMeta> namedColumnMeta(String sql) {
        return columnMeta(sql,getNamedParameterJdbcTemplate());
    }
...
//            }
    ...
    public <T> List<T> findForObject(String sql, Class<T> clz, Object... args) {
        return getJdbcTemplate().queryForList(sql,clz,args);
    }
    ...
    public <T> List<T> find(String sql, Class<T> clz, Map<String, Object> params) {
        return getNamedParameterJdbcTemplate().query(sql,params,RowMapperUtil.newRowMapper(clz));
    }
    ...
    public List<Map<String, Object>> find(String sql, Map<String, Object> params) {
        ...
        return getNamedParameterJdbcTemplate().query(sql,params,RowMapperUtil.newMapMapper());
    }
    ...
    public <T> List<T> findForObject(String sql, Map<String, Object> params, Class<T> clz) {
        log.info("sql:{},params:{}",sql,params);
        return getNamedParameterJdbcTemplate().queryForList(sql,params,clz);
    }
}
