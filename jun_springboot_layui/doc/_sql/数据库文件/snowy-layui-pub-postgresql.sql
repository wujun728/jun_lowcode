...
INSERT INTO "public"."sys_config" VALUES (1270380786649982740, 'Snowy演示环境', 'SNOWY_DEMO_ENV_FLAG', 'false', 'Y', 'Snowy演示环境的开关，true-打开，false-关闭，如果演示环境开启，则只能读数据不能写数据', 0, 'DEFAULT', '2020-06-09 23:42:37', 1265476890672672808, '2021-01-22 17:50:33', 1265476890672672808);
...
INSERT INTO "public"."sys_config" VALUES (1288309751255412737, 'Oauth用户登录的开关', 'SNOWY_ENABLE_OAUTH_LOGIN', 'false', 'Y', 'Oauth用户登录的开关', 0, 'OAUTH', '2020-07-29 11:05:55', 1265476890672672808, NULL, NULL);
...
INSERT INTO "public"."sys_config" VALUES (1288310280056483841, 'Oauth码云登录回调地址', 'SNOWY_OAUTH_GITEE_REDIRECT_URI', 'http://127.0.0.1:81/oauth/callback/gitee', 'Y', 'Oauth码云登录回调地址', 0, 'OAUTH', '2020-07-29 11:08:01', 1265476890672672808, NULL, NULL);
INSERT INTO "public"."sys_config" VALUES (1288358228593221636, '是否开启验证码', 'SNOWY_CAPTCHA_OPEN', 'true', 'Y', '是否开启验证码', 0, 'DEFAULT', '2020-09-03 17:45:58', 1265476890672672808, '2020-09-23 22:23:38', 1265476890672672808);
INSERT INTO "public"."sys_config" VALUES (1375337991869853697, 'OnlyOffice服务地址', 'SNOWY_ONLY_OFFICE_SERVICE_URL', 'http://82.156.81.108:9001', 'Y', 'OnlyOffice服务地址，开发时请使用局域网内地址', 0, 'DEFAULT', '2021-03-26 14:45:04', 1265476890672672808, '2021-03-26 14:51:44', 1265476890672672808);
