...
-- ----------------------------
INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265117443880853506', N'jwt密钥', N'QIXING_JWT_SECRET', N'snowy', N'Y', N'（重要）jwt密钥，默认为空，自行设置', N'0', N'DEFAULT', N'2020-05-26 06:35:19', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265117443880853507', N'默认密码', N'QIXING_DEFAULT_PASSWORD', N'123456', N'Y', N'默认密码', N'0', N'DEFAULT', N'2020-05-26 06:37:56', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265117443880853508', N'token过期时间', N'QIXING_TOKEN_EXPIRE', N'86400', N'Y', N'token过期时间（单位：秒）', N'0', N'DEFAULT', N'2020-05-27 11:54:49', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265117443880853509', N'session会话过期时间', N'QIXING_SESSION_EXPIRE', N'7200', N'Y', N'session会话过期时间（单位：秒）', N'0', N'DEFAULT', N'2020-05-27 11:54:49', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265117443880853519', N'阿里云短信keyId', N'QIXING_ALIYUN_SMS_ACCESSKEY_ID', N'你的keyId', N'Y', N'阿里云短信keyId', N'0', N'ALIYUN_SMS', N'2020-06-07 16:27:11', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269547042242371585', N'阿里云短信secret', N'QIXING_ALIYUN_SMS_ACCESSKEY_SECRET', N'你的secret', N'Y', N'阿里云短信secret', N'0', N'ALIYUN_SMS', N'2020-06-07 16:29:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269547130041737217', N'阿里云短信签名', N'QIXING_ALIYUN_SMS_SIGN_NAME', N'Snowy快速开发平台', N'Y', N'阿里云短信签名', N'0', N'ALIYUN_SMS', N'2020-06-07 16:29:58', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269547279530926081', N'阿里云短信-登录模板号', N'QIXING_ALIYUN_SMS_LOGIN_TEMPLATE_CODE', N'SMS_1877123456', N'Y', N'阿里云短信-登录模板号', N'0', N'ALIYUN_SMS', N'2020-06-07 16:30:33', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269547410879750145', N'阿里云短信默认失效时间', N'QIXING_ALIYUN_SMS_INVALIDATE_MINUTES', N'5', N'Y', N'阿里云短信默认失效时间（单位：分钟）', N'0', N'ALIYUN_SMS', N'2020-06-07 16:31:04', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269575927357071361', N'腾讯云短信secretId', N'QIXING_TENCENT_SMS_SECRET_ID', N'你的secretId', N'Y', N'腾讯云短信secretId', N'0', N'TENCENT_SMS', N'2020-06-07 18:24:23', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269575991693500418', N'腾讯云短信secretKey', N'QIXING_TENCENT_SMS_SECRET_KEY', N'你的secretkey', N'Y', N'腾讯云短信secretKey', N'0', N'TENCENT_SMS', N'2020-06-07 18:24:39', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269576044084551682', N'腾讯云短信sdkAppId', N'QIXING_TENCENT_SMS_SDK_APP_ID', N'1400375123', N'Y', N'腾讯云短信sdkAppId', N'0', N'TENCENT_SMS', N'2020-06-07 18:24:51', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1269576089294954497', N'腾讯云短信签名', N'QIXING_TENCENT_SMS_SIGN', N'Snowy快速开发平台', N'Y', N'腾讯云短信签名', N'0', N'TENCENT_SMS', N'2020-06-07 18:25:02', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270378172860403713', N'邮箱host', N'QIXING_EMAIL_HOST', N'smtp.126.com', N'Y', N'邮箱host', N'0', N'EMAIL', N'2020-06-09 23:32:14', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270378295543795714', N'邮箱用户名', N'QIXING_EMAIL_USERNAME', N'test@126.com', N'Y', N'邮箱用户名', N'0', N'EMAIL', N'2020-06-09 23:32:43', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270378340510928897', N'邮箱密码', N'QIXING_EMAIL_PASSWORD', N'你的邮箱密码', N'Y', N'邮箱密码', N'0', N'EMAIL', N'2020-06-09 23:32:54', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270378527358783489', N'邮箱端口', N'QIXING_EMAIL_PORT', N'465', N'Y', N'邮箱端口', N'0', N'EMAIL', N'2020-06-09 23:33:38', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270378790035460097', N'邮箱是否开启ssl', N'QIXING_EMAIL_SSL', N'true', N'Y', N'邮箱是否开启ssl', N'0', N'EMAIL', N'2020-06-09 23:34:41', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649972737', N'邮箱发件人', N'QIXING_EMAIL_FROM', N'test@126.com', N'Y', N'邮箱发件人', N'0', N'EMAIL', N'2020-06-09 23:42:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649972738', N'win本地上传文件路径', N'QIXING_FILE_UPLOAD_PATH_FOR_WINDOWS', N'd:/tmp', N'Y', N'win本地上传文件路径', N'0', N'FILE_PATH', N'2020-06-09 23:42:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649972739', N'linux/mac本地上传文件路径', N'QIXING_FILE_UPLOAD_PATH_FOR_LINUX', N'/tmp', N'Y', N'linux/mac本地上传文件路径', N'0', N'FILE_PATH', N'2020-06-09 23:42:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649982740', N'Snowy演示环境', N'QIXING_DEMO_ENV_FLAG', N'false', N'Y', N'Snowy演示环境的开关，true-打开，false-关闭，如果演示环境开启，则只能读数据不能写数据', N'0', N'DEFAULT', N'2020-06-09 23:42:37', N'1265476890672672808', N'2021-01-22 17:50:33', N'1265476890672672808')
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649982741', N'Snowy放开XSS过滤的接口', N'QIXING_UN_XSS_FILTER_URL', N'/demo/xssfilter,/demo/unxss', N'Y', N'多个url可以用英文逗号隔开', N'0', N'DEFAULT', N'2020-06-09 23:42:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1270380786649982742', N'单用户登陆的开关', N'QIXING_ENABLE_SINGLE_LOGIN', N'false', N'Y', N'单用户登陆的开关，true-打开，false-关闭，如果一个人登录两次，就会将上一次登陆挤下去', N'0', N'DEFAULT', N'2020-06-09 23:42:37', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1280694281648070659', N'阿里云定位api接口地址', N'QIXING_IP_GEO_API', N'http://api01.aliyun.venuscn.com/ip?ip=%s', N'Y', N'阿里云定位api接口地址', N'0', N'DEFAULT', N'2020-07-20 10:44:46', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1280694281648070660', N'阿里云定位appCode', N'QIXING_IP_GEO_APP_CODE', N'461535aabeae4f34861884d392f5d452', N'Y', N'阿里云定位appCode', N'0', N'DEFAULT', N'2020-07-20 10:44:46', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288309751255412737', N'Oauth用户登录的开关', N'QIXING_ENABLE_OAUTH_LOGIN', N'false', N'Y', N'Oauth用户登录的开关', N'0', N'OAUTH', N'2020-07-29 11:05:55', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288310043346743297', N'Oauth码云登录ClientId', N'QIXING_OAUTH_GITEE_CLIENT_ID', N'你的clientId', N'Y', N'Oauth码云登录ClientId', N'0', N'OAUTH', N'2020-07-29 11:07:05', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288310157876408321', N'Oauth码云登录ClientSecret', N'QIXING_OAUTH_GITEE_CLIENT_SECRET', N'你的clientSecret', N'Y', N'Oauth码云登录ClientSecret', N'0', N'OAUTH', N'2020-07-29 11:07:32', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288310280056483841', N'Oauth码云登录回调地址', N'QIXING_OAUTH_GITEE_REDIRECT_URI', N'http://127.0.0.1:81/oauth/callback/gitee', N'Y', N'Oauth码云登录回调地址', N'0', N'OAUTH', N'2020-07-29 11:08:01', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288358228593221636', N'是否开启验证码', N'QIXING_CAPTCHA_OPEN', N'true', N'Y', N'是否开启验证码', N'0', N'DEFAULT', N'2020-09-03 17:45:58', N'1265476890672672808', N'2020-09-23 22:23:38', N'1265476890672672808')
GO

INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1375337991869853697', N'OnlyOffice服务地址', N'QIXING_ONLY_OFFICE_SERVICE_URL', N'http://82.156.81.108:9001', N'Y', N'OnlyOffice服务地址，开发时请使用局域网内地址', N'0', N'DEFAULT', N'2021-03-26 14:45:04', N'1265476890672672808', N'2021-03-26 14:51:44', N'1265476890672672808')
GO
...
INSERT INTO [dbo].[SYS_DICT_DATA] ([ID], [TYPE_ID], [VALUE], [CODE], [SORT], [REMARK], [STATUS], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1265216536659087361', N'1265216211667636235', N'默认常量', N'DEFAULT', N'100', N'默认常量，都以QIXING_开头的', N'0', N'2020-04-14 23:25:45', N'1265476890672672808', NULL, NULL)
GO
