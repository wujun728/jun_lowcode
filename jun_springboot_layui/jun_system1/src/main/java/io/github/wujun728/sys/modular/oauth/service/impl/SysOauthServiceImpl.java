...
package io.github.wujun728.sys.modular.oauth.service.impl;
...
import io.github.wujun728.sys.core.cache.OauthCache;
import io.github.wujun728.sys.modular.auth.service.AuthService;
import io.github.wujun728.sys.modular.oauth.entity.SysOauthUser;
import io.github.wujun728.sys.modular.oauth.enums.SysOauthExceptionEnum;
import io.github.wujun728.sys.modular.oauth.enums.SysOauthPlatformEnum;
import io.github.wujun728.sys.modular.oauth.mapper.SysOauthMapper;
...
public class SysOauthServiceImpl extends ServiceImpl<SysOauthMapper, SysOauthUser> implements SysOauthService {
    ...
    private AuthRequest getAuthRequest(String source) {
        ...
        if (source.toLowerCase().equals(SysOauthPlatformEnum.GITEE.getCode())) {
            ...
            authRequest = new AuthGiteeRequest(AuthConfig.builder()
                    ...
                    .build(), oauthCache);
        } else if (source.toLowerCase().equals(SysOauthPlatformEnum.GITHUB.getCode())) {
