...
import io.github.wujun728.core.util.PoiUtil;
import io.github.wujun728.sys.modular.emp.param.SysEmpParam;
import io.github.wujun728.sys.modular.emp.result.SysEmpInfo;
...
import io.github.wujun728.sys.modular.oauth.enums.SysOauthSexEnum;
...
import io.github.wujun728.sys.modular.user.enums.SysUserExceptionEnum;
import io.github.wujun728.sys.modular.user.enums.SysUserSexEnum;
import io.github.wujun728.sys.modular.user.factory.SysUserFactory;
import io.github.wujun728.sys.modular.user.mapper.SysUserMapper;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public PageResult<SysUserResult> page(SysUserParam sysUserParam) {
        ...
        if (ObjectUtil.isNotNull(sysUserParam)) {
            ...
            //排序
            if(ObjectUtil.isAllNotEmpty(sysUserParam.getSortBy(), sysUserParam.getOrderBy())) {
                queryWrapper.orderBy(true, sysUserParam.getOrderBy().equals(CommonConstant.ASC), StrUtil.toUnderlineCase(sysUserParam.getSortBy()));
            }
        }
        //查询非删除状态，排除超级管理员
    ...
    public List<Dict> list(SysUserParam sysUserParam) {
        ...
        queryWrapper.eq(SysUser::getStatus, CommonStatusEnum.ENABLE.getCode())
                .ne(SysUser::getAdminType, SysUserAdminTypeEnum.SUPER_ADMIN.getCode());
    ...
    public void export(SysUserParam sysUserParam) {
        ...
        PoiUtil.exportExcelWithStream("QixingUsers.xls", SysUser.class, list);
    }
    ...
    public void saveAuthUserToUser(AuthUser authUser, SysUser sysUser) {
        ...
        if (ObjectUtil.isNotNull(authUser.getGender())) {
            ...
            //性别转换
            if (SysOauthSexEnum.MAN.getCode().equals(gender.getCode())) {
                sysUser.setSex(SysUserSexEnum.MAN.getCode());
            } else if (SysOauthSexEnum.WOMAN.getCode().equals(gender.getCode())) {
                sysUser.setSex(SysUserSexEnum.WOMAN.getCode());
            } else {
                sysUser.setSex(SysUserSexEnum.NONE.getCode());
            }
        }
        this.save(sysUser);
    }
    ...
    public List<Long> getAllUserIdList() {
        ...
        LambdaQueryWrapper<SysUser> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.ne(SysUser::getAdminType, SysUserAdminTypeEnum.SUPER_ADMIN.getCode());
        this.list(queryWrapper).forEach(sysUser -> {
