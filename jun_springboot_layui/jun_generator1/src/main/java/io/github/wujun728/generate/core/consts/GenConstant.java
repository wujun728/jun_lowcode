...
package io.github.wujun728.generate.core.consts;
...
public class GenConstant {
     ...
     * html文件夹
     */
    public static String BASE_HTML_PATH = FILE_SEP + "src" + FILE_SEP + "main" + FILE_SEP + "webapp" + FILE_SEP + "templates" + FILE_SEP;
    ...
    public static String[] xnCodeGenFilePath (String busName, String packageName, String className) {
        ...
        htmlPath = BASE_HTML_PATH + FILE_SEP + className + FILE_SEP;
        htmlFormPath = BASE_HTML_PATH + FILE_SEP + className + FILE_SEP;
        mysqlSqlPath = BASE_SQL_PATH;
        oracleSqlPath = BASE_SQL_PATH;
        return new String[] {
                controllerPath, entityPath, enumsPath, mapperPath, mappingPath, paramPath, servicePath, serviceImplPath, htmlPath, htmlFormPath, mysqlSqlPath, oracleSqlPath
        };
    }
